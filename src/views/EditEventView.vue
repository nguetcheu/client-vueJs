  ...
  <div class="edit-event-container">
    ...
    <form v-else @submit.prevent="handleUpdate" class="event-form">
      ...
      <div class="actions">
        ...
        <button type="button" @click="router.push('/dashboard')" class="cancel-btn">
          Annuler
        </button>
      </div>
    </form>
...
<style scoped>
.edit-event-container { max-width: 600px; margin: 40px auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px; }
...
.save-btn { flex: 2; background: #f39c12; color: white; border: none; padding: 12px; border-radius: 4px; cursor: pointer; font-weight: bold; }
.cancel-btn { flex: 1; background: #95a5a6; color: white; border: none; padding: 12px; border-radius: 4px; cursor: pointer; }
